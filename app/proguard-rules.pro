...
# 将下面替换成自己的实体类
-keep class com.thrid.db.entity.** { *; }
-keep class com.thrid.model.** { *; }
-keep class com.zimi.bookstore.bean.** { *; }
-keep class com.zimi.bookstore.net_api.request.** { *; }
-keep class com.zimi.bookstore.net_api.response.** { *; }
-keep class com.alick.utilslibrary.recyclermanager.** { *; }
-keep class com.zimi.bookstore.common.bean.** { *; }
...
-keep public class * extends me.drakeet.multitype.ItemViewBinder{*;}
-keep public class * extends com.zimi.bookstore.common.base.adapter.IMultiViewBinder{*;}
#反射时需要keep的超类-end
